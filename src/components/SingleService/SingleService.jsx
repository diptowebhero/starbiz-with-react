                    ...
                    <div className="row mt-4">
                      <div className="col-md-6">
                        <ul className="list-unstyled list-icon">
                          ...
                          <li>
                            <i className="las la-check-circle"></i>Fast-Track
                            Your business
                          </li>
                          <li>
                          ...
                          <li>
                            <i className="las la-check-circle"></i>Listening
                            Your Needs for IT Strategy
                          </li>
                          <li>
                      ...
                      <div className="accordion-item bg-transparent mb-4">
                        ...
                        >
                          <div className="accordion-body">
                            For the incapable bliss of present souls like mine.
