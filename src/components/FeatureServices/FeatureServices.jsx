                  ...
                  <div className='service-item style-3'>
                    ...
                    <div className='service-desc'>
                      ...
                      <ul className='list-unstyled'>
                        ...
                        <li>
                          <i className='flaticon-forward'></i>Cross-Platform Compatibility
                        </li>
                      </ul>
                  ...
                  <div className='service-item style-3'>
                    ...
                    <div className='service-desc'>
                      ...
                      <ul className='list-unstyled'>
                        ...
                        <li>
                          <i className='flaticon-forward'></i>Customizable Dashboards
                        </li>
                        <li>
                          <i className='flaticon-forward'></i>Workflow Automation
                        </li>
                        <li>
                          <i className='flaticon-forward'></i>Scalability Options
                        </li>
                      </ul>
                ...
                <div className='item'>
                  <div className='service-item style-3'>
                    ...
                    <div className='service-desc'>
                      ...
                      <ul className='list-unstyled'>
                        <li>
                          <i className='flaticon-forward'></i>Intuitive Navigation
                        </li>
                        <li>
                          <i className='flaticon-forward'></i>Visual Appeal
                        </li>
                        <li>
                          <i className='flaticon-forward'></i>Seamless Interactions
                        </li>
                        <li>
