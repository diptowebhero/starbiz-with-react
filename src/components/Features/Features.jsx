import aboutImg from "./../../assets/images/about/08.jpg";
const Features = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-12 col-lg-6 mb-5 mb-lg-0">
              <div className="row">
                <div className="col-md-6">
                  <div className="featured-item style-1">
                    <div className="featured-icon">
                      <i
                        aria-hidden="true"
                        className="flaticon flaticon-statistics"
                      ></i>
                    </div>
                ...
                <div className="col-md-6">
                  <div className="featured-item style-1">
                    <div className="featured-icon">
                      <i aria-hidden="true" className="flaticon flaticon-idea"></i>
                    </div>
                    <div className="featured-description">
                      <div className="featured-title">
                ...
                <div className="col-md-6">
                  <div className="featured-item style-1">
                    <div className="featured-icon">
                      <i
                        aria-hidden="true"
                        className="flaticon flaticon-rocket-launch"
                      ></i>
                    </div>
                    <div className="featured-description">
                      <div className="featured-title">
                ...
                <div className="col-md-6">
                  <div className="featured-item style-1">
                    <div className="featured-icon">
                      <i
                        aria-hidden="true"
                        className="flaticon flaticon-announcement"
                      ></i>
                    </div>
                    <div className="featured-description">
                      <div className="featured-title">
            ...
            <div className="col-12 col-lg-6 position-relative">
              <img src={aboutImg} className="img-fluid rounded img-filter" alt="" />
